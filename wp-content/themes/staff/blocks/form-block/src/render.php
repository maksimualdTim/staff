...
<section class="form-block section" <?= get_block_wrapper_attributes(); ?>>
	<div class="form-block-container">
		<div class="form-section-content">
			<h2 class="form-section-title"><?= esc_html($attributes['title']); ?></h2>
			...
			<div class="agreement">
				<svg  class="agreement-svg" width="23" height="24" viewBox="0 0 23 24" fill="none" xmlns="http://www.w3.org/2000/svg">

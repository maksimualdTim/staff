...
document.addEventListener('DOMContentLoaded', () => {
	jQuery('.slick-slider').slick({
		...
		slidesToShow: 1,
		slidesToScroll: 1,
		centerMode: true, // Активный слайд будет в центре
		centerPadding: '0px', // Убрать дополнительные отступы вокруг
		speed: 500, // Скорость анимации в миллисекундах
		variableWidth: true, // Учитывать индивидуальную ширину слайда
		cssEase: 'ease-in-out', // Плавность анимации
		appendDots: jQuery('.custom-dots-container'), // Указываем контейнер для точек
		prevArrow: '' +
